...
public class StrategyRepository implements IStrategyRepository {
    ...
    public List<RuleWeightVO> queryAwardRuleWeight(Long strategyId) {
        ...
        // 3. 遍历规则组装奖品配置
        Map<Integer, String> strategyAwardIdTitle = queryAwardIdValueByStrategy(strategyId);
        ...
        for (String ruleWeightKey : ruleWeightKeys) {
            ...
            for (Integer awardId : awardIds) {
                ...
                strategyAwardReq.setStrategyId(strategyId);
                strategyAwardReq.setAwardId(awardId);
                String awardTitle = strategyAwardIdTitle.get(awardId);
    ...
    @Override
    public Map<Integer, String> queryAwardIdValueByStrategy(Long strategyId) {
        List<StrategyAward> strategyAwardList = strategyAwardDao.queryStrategyAwardListByStrategyId(strategyId);
        Map<Integer, String> awardIdValue = new HashMap<>();
